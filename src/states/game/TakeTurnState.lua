            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local healthIncrease, atkIncrease, defIncrease, spdIncrease = self.playerPokemon:levelUp()

                        gStateStack:push(ResultMenuState(self, healthIncrease, atkIncrease, defIncrease, spdIncrease))
                        gStateStack:push(BattleMessageState('Congratulations! Level Up! Your ' .. self.playerPokemon.name .. ' grows stronger!',
                        function()
