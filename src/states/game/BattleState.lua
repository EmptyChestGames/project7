...
function BattleState:render()
    ...
    if self.renderHealthBars then
        ...
        love.graphics.print(tostring(self.playerPokemon.currentHP) .. '/' .. tostring(self.playerPokemon.HP), 200, 135)
        love.graphics.print(tostring(math.floor(self.playerPokemon.currentExp)) .. '/' .. tostring(math.floor(self.playerPokemon.expToLevel)), 200, 145)
